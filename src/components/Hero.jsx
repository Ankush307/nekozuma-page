    ...
    return (
        <div className="relative mx-auto overflow-hidden">
            ...
            <div className="d-flex align-items-center position-relative hero-nokozuma justify-content-center">
                ...
                <Image className="pe-none position-absolute bottom-0 start-0 left-vector" src="/assets/images/webp/hero-left-vector.webp" alt="left vector" width={355} height={411} />
