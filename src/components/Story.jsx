    ...
    return (
        <div id='story'>
            <div className="container mx-auto mt-5">
                ...
                <p className='text-center ff-franklin text-xs pt-3 fw-normal text-light-blue mx-auto mb-0 story-description-2 fs-xs'>However at every junction in time, there is always a darkness that is waiting to overthrow the good. Hence, each timeline has its own arch nemesis. This means that there will be a total of 4 godly nekos from each timeline making a total of 12 godly nekos that will be fully animated.</p>
            </div>
            <Image src='/assets/images/webp/about-us-cats.webp' alt='cat-battle' width={1280} height={357} className='w-100 h-auto' />
        </div>
    );
}
